...
user_agent = 'Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36'
...
start_url = f'https://www.goibibo.com/flights/'
...
driver.find_element(By.XPATH,'//*[@id="root"]/div[4]/div/div/div[1]/div[1]/div/div').click()
time.sleep(0.5)

driver.find_element(By.XPATH, '//*[@id="root"]/div[4]/div/div/div[1]/div[1]/div/div[2]/div/input').send_keys(source)
time.sleep(0.5)
...
driver.find_element(By.XPATH, '//*[@id="root"]/div[4]/div/div/div[1]/div[1]/div/div[2]/div/input').send_keys(Keys.ENTER)
time.sleep(0.5)

driver.find_element(By.XPATH, '//*[@id="root"]/div[4]/div/div/div[1]/div[2]/div/div[2]/div/input').send_keys(destination)
time.sleep(0.5)

driver.find_element(By.XPATH, '//*[@id="root"]/div[4]/div/div/div[1]/div[2]/div/div[2]/div/input').send_keys(Keys.ENTER)
time.sleep(1.5)

driver.find_element(By.XPATH,'//*[@id="root"]/div[4]/div/div/div[1]/div[3]/div[2]/div[2]/div/div/div[2]/div[2]/div[3]/div[1]/div[4]/p').click()
                            

driver.find_element(By.XPATH,'//*[@id="root"]/div[4]/div/div/div[1]/div[3]/div[2]/div[3]/span[2]').click()
time.sleep(1.0)

driver.find_element(By.XPATH,'//*[@id="root"]/div[4]/div/div/div[3]/span').click()
time.sleep(2.0)
